...
export const createSchool = asyncHandler(async (req, res) => {
  ...
  const school = await School.create({
    ...
    logo: logoData,
    createdBy: "691afb633943df5e1d0b70c7",
    updatedBy: "691afb633943df5e1d0b70c7",
  });
...
// ham chahte hai ki school ke Employee student ko register kare aur exam create kare 