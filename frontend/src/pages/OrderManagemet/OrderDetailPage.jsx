              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="flex items-center">
                    <span
                      className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold border ${getStatusBadge("payment", order.paymentStatus)}`}
                    >
                      {order.paymentStatus === "pending"
                        ? "Pending Payment"
                        : order.paymentStatus}
                ...
                <div>
                  <p className="text-sm text-gray-500 mb-2">Dispatch Status</p>
                  <span
                    className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold border ${getStatusBadge("dispatch", order.dispatchStatus)}`}
                  >
