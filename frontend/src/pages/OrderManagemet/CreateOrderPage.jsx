...
const CreateOrderPage = () => {
  ...
  }, [formData.orderItems, formData.kitItems, formData.discountPercentage, formData.gstPercentage]);
  ...
  useEffect(() => {
    updateTotals();
  }, [formData.orderItems, formData.kitItems, formData.discountPercentage, formData.gstPercentage, updateTotals]);
  ...
  const { orderTotal, kitTotal, subtotal, discountAmount, gstAmount, total } = calculateTotals();
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
            <h2 className="text-xl font-bold text-gray-800 mb-6 flex items-center">
              <div className="w-10 h-10 bg-[#0B234A]/10 rounded-lg flex items-center justify-center mr-3">
                <svg className="w-6 h-6 text-[#0B234A]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="bg-gradient-to-r from-[#0B234A]/5 to-[#0B234A]/10 rounded-xl p-6 border border-[#0B234A]/20">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-base font-semibold text-gray-900">{selectedSchool.contactPersonName}</p>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-gray-600">Mobile</p>
                      <p className="text-base font-semibold text-gray-900">{selectedSchool.mobile}</p>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-gray-600">Email</p>
                      <p className="text-base font-semibold text-gray-900">{selectedSchool.email}</p>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-gray-600">Address</p>
                      <p className="text-base font-semibold text-gray-900">{selectedSchool.address}, {selectedSchool.city}, {selectedSchool.state}</p>
                    </div>
                  </div>
                </div>
              )}
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
            <h2 className="text-xl font-bold text-gray-800 mb-6 flex items-center">
              <div className="w-10 h-10 bg-[#EA8E0A]/10 rounded-lg flex items-center justify-center mr-3">
                <svg className="w-6 h-6 text-[#EA8E0A]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                </svg>
              </div>
              2. Add Books
                  ...
                  <div className="bg-gradient-to-r from-[#FFF3CD] to-[#FFF8E1] rounded-xl p-6 border border-[#EA8E0A]/30">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      {getGradesForBookType("ELP").map((grade) => (
                        ...
                        >
                          <div className="font-bold text-base">{grade} Combo Pack</div>
                          <div className="text-sm mt-2 opacity-75">Set price manually</div>
                          {elpCombos[grade] && (
                      ...
                      <div className="w-full md:w-auto">
                        <div className="flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-4">
                          <div className="flex-1">
                            <select
                              value={selectedIndividualBook}
                              onChange={(e) => setSelectedIndividualBook(e.target.value)}
            ...
            {formData.orderItems.length > 0 && (
              <div className="mt-8">
                <h3 className="text-lg font-bold text-gray-800 mb-4 flex items-center">
                  <svg className="w-5 h-5 mr-2 text-[#0B234A]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <tr key={index} className="hover:bg-gray-50 transition-colors">
                          ...
                          <td className="px-6 py-4">
                            <input
                              ...
                              value={item.quantity}
                              onChange={(e) =>
                                updateItem(index, "quantity", e.target.value, "order")
                              }
                          ...
                          <td className="px-6 py-4">
                            <div className="relative">
                              ...
                              <input
                                ...
                                value={item.unitPrice}
                                onChange={(e) =>
                                  updateItem(index, "unitPrice", e.target.value, "order")
                                }
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
            <h2 className="text-xl font-bold text-gray-800 mb-6 flex items-center">
              <div className="w-10 h-10 bg-[#E22213]/10 rounded-lg flex items-center justify-center mr-3">
                <svg className="w-6 h-6 text-[#E22213]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
              ...
              >
                <div className="font-bold text-lg text-purple-800 mb-2">Wonder Kit</div>
                <div className="text-sm text-purple-600">Set price manually</div>
              </button>
              ...
              >
                <div className="font-bold text-lg text-indigo-800 mb-2">Nexus Kit</div>
                <div className="text-sm text-indigo-600">Set price manually</div>
              </button>
              ...
              >
                <div className="font-bold text-lg text-gray-800 mb-2">Individual Kit</div>
                      ...
                      <div className="flex items-center space-x-4">
                        <div className="relative">
                          <input
                            ...
                            placeholder="0"
                          />
                          <span className="absolute right-10 top-2.5 text-gray-500 font-bold">%</span>
                        </div>
